...
public class UsersApi {
  ...
  * 
   ...
   * @return DeliveryReclamation
  */
  public DeliveryReclamation usersUuidSubscriptionsSubsnoReclamationReclaimnoGet (UUID uuid, Integer subsno, Integer reclaimno, String authorization) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'uuid' is set
    if (uuid == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'uuid' when calling usersUuidSubscriptionsSubsnoReclamationReclaimnoGet",
        new ApiException(400, "Missing the required parameter 'uuid' when calling usersUuidSubscriptionsSubsnoReclamationReclaimnoGet"));
    }
    // verify the required parameter 'subsno' is set
    if (subsno == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'subsno' when calling usersUuidSubscriptionsSubsnoReclamationReclaimnoGet",
        new ApiException(400, "Missing the required parameter 'subsno' when calling usersUuidSubscriptionsSubsnoReclamationReclaimnoGet"));
    }
    // verify the required parameter 'reclaimno' is set
    if (reclaimno == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'reclaimno' when calling usersUuidSubscriptionsSubsnoReclamationReclaimnoGet",
        new ApiException(400, "Missing the required parameter 'reclaimno' when calling usersUuidSubscriptionsSubsnoReclamationReclaimnoGet"));
    }

    // create path and map variables
    String path = "/users/{uuid}/subscriptions/{subsno}/reclamation/{reclaimno}".replaceAll("\\{" + "uuid" + "\\}", apiInvoker.escapeString(uuid.toString())).replaceAll("\\{" + "subsno" + "\\}", apiInvoker.escapeString(subsno.toString())).replaceAll("\\{" + "reclaimno" + "\\}", apiInvoker.escapeString(reclaimno.toString()));
  ...
  */
  public void usersUuidSubscriptionsSubsnoReclamationReclaimnoGet (UUID uuid, Integer subsno, Integer reclaimno, String authorization, final Response.Listener<DeliveryReclamation> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/users/{uuid}/subscriptions/{subsno}/reclamation/{reclaimno}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "uuid" + "\\}", apiInvoker.escapeString(uuid.toString())).replaceAll("\\{" + "subsno" + "\\}", apiInvoker.escapeString(subsno.toString())).replaceAll("\\{" + "reclaimno" + "\\}", apiInvoker.escapeString(reclaimno.toString()));
