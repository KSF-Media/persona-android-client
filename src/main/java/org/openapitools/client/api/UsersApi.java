...
import org.openapitools.client.model.DeliveryReclamationUpdate;
...
public class UsersApi {
  ...
  * 
   ...
   * @return DeliveryReclamation
  */
  public DeliveryReclamation usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch (UUID uuid, Integer subsno, Integer reclaimno, DeliveryReclamationUpdate body, String authorization) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = body;
    // verify the required parameter 'uuid' is set
    if (uuid == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'uuid' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch",
        new ApiException(400, "Missing the required parameter 'uuid' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch"));
    }
    // verify the required parameter 'subsno' is set
    if (subsno == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'subsno' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch",
        new ApiException(400, "Missing the required parameter 'subsno' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch"));
    }
    // verify the required parameter 'reclaimno' is set
    if (reclaimno == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'reclaimno' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch",
        new ApiException(400, "Missing the required parameter 'reclaimno' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch"));
    }
    // verify the required parameter 'body' is set
    if (body == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'body' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch",
        new ApiException(400, "Missing the required parameter 'body' when calling usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch"));
    }
   ...
   * Update a delivery reclamation
   * 
   * @param uuid    * @param subsno    * @param reclaimno    * @param body    * @param authorization 
  */
  public void usersUuidSubscriptionsSubsnoReclamationsReclaimnoPatch (UUID uuid, Integer subsno, Integer reclaimno, DeliveryReclamationUpdate body, String authorization, final Response.Listener<DeliveryReclamation> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
