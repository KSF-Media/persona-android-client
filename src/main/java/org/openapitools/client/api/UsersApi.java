...
public class UsersApi {
  ...
  */
  public LoginResponse usersAdminPost (AdminNewUser body, UUID authUser, String authorization) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'body' when calling usersAdminPost",
        new ApiException(400, "Missing the required parameter 'body' when calling usersAdminPost"));
    }
  ...
  */
  public void usersAdminPost (AdminNewUser body, UUID authUser, String authorization, final Response.Listener<LoginResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
    ...
    // create path and map variables
    String path = "/users/admin".replaceAll("\\{format\\}","json");
  ...
  * deprecated
   ...
   * @return List<User>
  */
  public List<User> usersSearchGet (String query, UUID authUser, String authorization) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'query' is set
    if (query == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'query' when calling usersSearchGet",
        new ApiException(400, "Missing the required parameter 'query' when calling usersSearchGet"));
    }

    // create path and map variables
    String path = "/users/search";
