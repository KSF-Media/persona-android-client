...
public class AccountApi {
  ...
  * The second step in the forgotten password reset procedure is to ensure that the password reset token is still valid. Each token can be used at most once and it is valid for a limited duration.
   ...
   * @return void
  */
  public void accountPasswordCheckTokenPost (String body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'body' when calling accountPasswordCheckTokenPost",
        new ApiException(400, "Missing the required parameter 'body' when calling accountPasswordCheckTokenPost"));
    }

    // create path and map variables
    String path = "/account/password/check-token";
   ...
   * @param body 
  */
  public void accountPasswordCheckTokenPost (String body, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
    ...
    // create path and map variables
    String path = "/account/password/check-token".replaceAll("\\{format\\}","json");
  ...
  * This is the starting point of the forgotten password recovery process. It sends a password reset link with a pasword reset token to the given user&#39;s email address if such user and email address exist.
   ...
   * @return void
  */
  public void accountPasswordForgotPost (ForgotPasswordData body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @param body 
  */
  public void accountPasswordForgotPost (ForgotPasswordData body, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  * The final step of the forgotten password reset procedure performs password reset with a token obtained from the email message sent by the POST /password/forgot endpoint and the new password and its confirmation.
   ...
   * @return void
  */
  public void accountPasswordResetPost (UpdatePasswordData body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
