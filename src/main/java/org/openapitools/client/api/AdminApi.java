...
public class AdminApi {
  ...
  * 
   ...
   * @return void
  */
  public void adminUserUuidDelete (UUID uuid, UUID authUser, String authorization) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'uuid' is set
    if (uuid == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'uuid' when calling adminUserUuidDelete",
        new ApiException(400, "Missing the required parameter 'uuid' when calling adminUserUuidDelete"));
    }

    // create path and map variables
    String path = "/admin/user/{uuid}".replaceAll("\\{" + "uuid" + "\\}", apiInvoker.escapeString(uuid.toString()));
  ...
  */
  public void adminUserUuidDelete (UUID uuid, UUID authUser, String authorization, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/admin/user/{uuid}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "uuid" + "\\}", apiInvoker.escapeString(uuid.toString()));
